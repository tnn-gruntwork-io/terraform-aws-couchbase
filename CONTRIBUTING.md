...
functionality you're adding in your contribution. Check out the [tests](https://github.com/tnn-gruntwork-io/terraform-aws-couchbase/tree/main/test) folder for instructions on running the 
automated tests. 
